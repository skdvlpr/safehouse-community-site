...
return [
    ...
    'five_per_mille' => [
        ...
        'heading' => [
            'it' => 'Dona il 5 per mille',
            'en' => 'Donate your 5 per thousand',
            'ru' => 'Пожертвуйте 5 на тысячу',
        ],
        'lead' => [
        ...
        'body' => [
            'it' => '<p>Il <strong>5 per mille</strong> è una quota dell’imposta sul reddito che lo Stato destina gratuitamente alle organizzazioni del terzo settore che scegli tu.</p><p>Non costa nulla in più: non è una donazione aggiuntiva, ma una scelta su come impiegare una piccola parte dell’IRPEF già dovuta.</p><p>Con il tuo 5 per mille sosteniamo accoglienza, pasti, orientamento legale e interventi sul territorio per persone in difficoltà.</p>',
            'en' => '<p>The <strong>5 per thousand</strong> is a share of income tax that the Italian state allocates free of charge to third-sector organisations you choose.</p><p>It costs you nothing extra: you are not making an additional donation, only deciding how a small part of your tax is used.</p><p>Your 5 per thousand helps us provide shelter, meals, legal guidance and outreach for people in need.</p>',
            'ru' => '<p><strong>5 на тысячу</strong> — это доля подоходного налога, которую государство бесплатно направляет выбранной вами некоммерческой организации.</p><p>Это не дополнительный платёж: вы лишь указываете, куда направить небольшую часть уже уплачиваемого налога.</p><p>Ваш выбор помогает нам обеспечивать приют, питание, юридическую поддержку и работу на территории.</p>',
        ],
        'instructions' => [
            'it' => '<ol><li>Apri la dichiarazione dei redditi (<strong>Modello 730</strong>, <strong>Redditi persone fisiche</strong> o <strong>CUD</strong>).</li><li>Cerca il riquadro <strong>«Destina il 5 per mille»</strong> / finanziamento del terzo settore.</li><li><strong>Firma</strong> nel riquadro per autorizzare la scelta.</li><li>Scrivi il <strong>codice fiscale</strong> dell’associazione nel campo dedicato.</li><li>Presenta la dichiarazione entro la scadenza prevista.</li></ol>',
            'en' => '<ol><li>Open your Italian tax return (<strong>Modello 730</strong>, <strong>Redditi PF</strong> or <strong>CUD</strong>).</li><li>Find the <strong>“5 per thousand”</strong> / third-sector funding box.</li><li><strong>Sign</strong> the box to authorise your choice.</li><li>Enter the association’s <strong>codice fiscale</strong> in the dedicated field.</li><li>Submit your return before the deadline.</li></ol>',
            'ru' => '<ol><li>Откройте налоговую декларацию (<strong>Modello 730</strong>, <strong>Redditi PF</strong> или <strong>CUD</strong>).</li><li>Найдите блок <strong>«5 per mille»</strong> / finanziamento del terzo settore.</li><li><strong>Подпишите</strong> поле, чтобы подтвердить выбор.</li><li>Укажите <strong>codice fiscale</strong> ассоциации в соответствующей графе.</li><li>Подайте декларацию до установленного срока.</li></ol>',
        ],
        'codice_label' => [
