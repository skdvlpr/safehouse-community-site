# Implementation Plan: News heading filters

**Branch**: `017-news-heading` | **Date**: 2026-09-25 | **Spec**: [spec.md](./spec.md)
...
**Scale/Scope**: `resources/views/pages/articles/index.blade.php`, `resources/views/pages/articles/partials/listing-toolbar.blade.php`, `resources/css/app.css`
