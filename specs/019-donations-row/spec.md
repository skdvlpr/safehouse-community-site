# Feature Specification: Donations heading row
...
**Input**: Owner 2026-09-25. Donazioni uses the Chi siamo heading: Donazioni | Sostieni Safe House. 5 x 1000 o pagamenti digitali. On a wide screen the 5 x 1000 block and the bank-transfer block sit on one row. On a narrow screen they stay stacked. The rest of the donations page stays as it is. The red label above the title is removed.
