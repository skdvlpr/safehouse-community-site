# Implementation Plan: FAQ heading

**Branch**: `013-faq-heading` | **Date**: 2026-09-25 | **Spec**: [spec.md](./spec.md)
...
**Scale/Scope**: `resources/views/pages/templates/default.blade.php`, `lang/it/site.php`, `lang/en/site.php`
...
```text
resources/views/pages/templates/default.blade.php
lang/it/site.php
lang/en/site.php
```
