# Implementation Plan: Services heading

**Branch**: `012-services-heading` | **Date**: 2026-09-25 | **Spec**: [spec.md](./spec.md)
...
**Scale/Scope**: `resources/views/pages/templates/services.blade.php`, `resources/views/pages/partials/page-header.blade.php`, `resources/css/app.css`
...
```text
resources/views/pages/templates/services.blade.php
