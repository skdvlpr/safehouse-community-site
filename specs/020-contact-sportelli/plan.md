# Implementation Plan: Contact sportelli copy

**Branch**: `020-contact-sportelli` | **Date**: 2026-09-25 | **Spec**: [spec.md](./spec.md)
...
**Scale/Scope**: `resources/views/pages/templates/contact.blade.php`, `lang/it/site.php`, `lang/en/site.php`
...
```text
resources/views/pages/templates/contact.blade.php
lang/it/site.php
lang/en/site.php
```
