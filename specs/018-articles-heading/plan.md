# Implementation Plan: Articles heading

**Branch**: `018-articles-heading` | **Date**: 2026-09-25 | **Spec**: [spec.md](./spec.md)
...
**Scale/Scope**: `resources/views/pages/editorial-articles/index.blade.php`, `resources/views/pages/partials/page-header.blade.php`, `resources/css/app.css`
...
```text
resources/views/pages/editorial-articles/index.blade.php
